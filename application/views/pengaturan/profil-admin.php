		...
		<div class="card-body">
			...
			<a href="tambah-admin">
				<button type="button" class="btn btn-primary btn-success mb-3" style="width:200px;height:44px">
					<i class="far fa-plus-square mr-2"></i>Tambah Admin
				</button>
			...
			<div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
				...
				<thead>
					...
					$no = 1;
					$ambildata = mysqli_query($koneksi, "select * from data_admin");
					while ($tampil = mysqli_fetch_array($ambildata)) {
						...
						echo "
									<tr bgcolor='$warna'>
										...
										<td>$tampil[divisi]</td>
										<td>$tampil[status]</td>
										<td>$tampil[tgl_dibuat]</td>	
										<td>
											<a href='?kode=$tampil[username]'>
				...
				if (isset($_GET['kode'])) {
					mysqli_query($koneksi, "delete from data_admin where Username='$_GET[kode]'");
